...
jQuery(window).resize(function () {
	...
	jQuery(".menu-left-part.open").width(
		jQuery(".sidebar.open").width() - jQuery(".menu-right-part.open").width()
	);
...
var multiClickFunctionStop = function (e) {
	...
	jQuery("html, body, .sidebar, .menu-left-part, .menu-right-part").toggleClass(
		"open"
	);

...
class Kasir_detail_sql extends CI_Model
{
    private $tabel = "kasir_detail";
    public $tabel_prefix = "";

    var $column_order = array(null, 'kasir', 'barang'); //field yang ada di table user
    var $column_search = array('kasir', 'barang'); //field yang diizin untuk pencarian 

...
class Purchase_detail_sql extends CI_Model
{
    private $tabel = "purchase_detail";
    public $tabel_prefix = "";

    var $column_order = array(null, 'purchase'); //field yang ada di table user
    var $column_search = array('purchase'); //field yang diizin untuk pencarian 
    var $order = array('purchase' => 'asc'); // default order 
    ...
    {
        if (empty($where)) $where = array("kasir" => 'temporary');
        $this->db->where($where);

  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Menu Navigation</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                      ...
                      <div class="card card-primary">
                          ...
                          <div class="card-body">
                              <div class="row margin">
                                  ...
                                  <div class="col-sm-2">
                                      <p>Tipe:</p>
                                      <input type="text" class="form-control" name="tipe" required="required"><br>
                                  </div>
                                  <div class="col-sm-2">
                                      <p>Root:</p>
                                      <input type="text" class="form-control" name="root" required="required"><br>
                                  </div>
                                  <div class="col-sm-2">
                                      <p>Icon:</p>
                              ...
                              <div class="modal-body">
                                  <form>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="tipe_edit" class="form-control"></input>
                                      </div>
                                      <div class="form-group">
                                          <label for="Root">Root</label>
                                          <input type="text" name="root_edit" class="form-control"></input>
                                      </div>
                                      <div class="form-group">
